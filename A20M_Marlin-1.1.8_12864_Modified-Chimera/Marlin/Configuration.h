...
#define CUSTOM_MACHINE_NAME "A20M Chimera"
...
#define HOTEND_OFFSET_X {0.0, 21.00} // (in mm) for each extruder, offset of the hotend on the X axis
#define HOTEND_OFFSET_Y {0.0, 1.00}  // (in mm) for each extruder, offset of the hotend on the Y axis
...
#define HOMING_FEEDRATE_Z  (20*60)//3Dtouch---5
